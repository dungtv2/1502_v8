...
class ShowFieldS(models.Model):
    ...
    color_for_list = fields.Boolean(string="Use Color/bgcolor for listview")sss
    ...
    def action(self, vals, action):
        group_show_fields = self.env.ref('dynamic_listview_advance_odoo_v8_1502.group_show_fields')
